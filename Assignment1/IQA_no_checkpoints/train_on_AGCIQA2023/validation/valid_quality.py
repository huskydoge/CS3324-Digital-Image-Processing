...
def valid_quality(data_path):
    ...
    for idx, item in tqdm(df_img_reward_trained.iterrows(), total=len(df_img_reward_trained)):
        if idx not in id_list:
            continue
        y_hat.append(item['quality_score'])
...
if __name__ == "__main__":
    table_list = ["/data/husky/ImageReward/assets/results/AIGCIQA2023/ImgRward_trained_for_authenticity.csv",
                  ...
                  "/data/husky/ImageReward/assets/results/AIGCIQA2023/ImgRward_trained_for_quality_epoch50_prompt1.csv",
                  "/data/husky/ImageReward/assets/results/AIGCIQA2023/ImgRward_trained_for_quality_epoch50_prompt3.csv",
