...
if __name__ == "__main__":
    ...
    model = load_model(model,
                       "./checkpoint/11110741_bsNone_fix=32_lr=0_for_quality_prompt1_epoch50/best_lr=5e-06.pt")
    ...
    for idx, item in tqdm(data_set.iterrows(), total=len(data_set)):
        ...
        with torch.no_grad():
            ...
            results.to_csv("../assets/results/AIGCIQA2023/ImgRward_disentangled.csv")
