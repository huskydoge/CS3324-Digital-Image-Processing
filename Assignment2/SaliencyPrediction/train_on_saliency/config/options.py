...
parser.add_argument('--model_name', type=str, default='blend', choices=['transalnet', 'blend', 'minisample'])

# training settings
parser.add_argument('--batch_size', type=int, default=32, help='')
parser.add_argument('--accumulation_steps', type=int, default=1, help='')
parser.add_argument('--epochs', type=int, default=10, help='')
parser.add_argument('--task', type=str, default="non_salient", help="the task to train and test on",
                    choices=["all", "pure", "non_salient", "whole", "salient", "oneforall"])
parser.add_argument('--train-iters', type=int, default=None,
                    help='total number of iterations to train over all training runs')
parser.add_argument('--reshape', default=False, type=bool)
parser.add_argument('--use_cross', default=0, type=int, choices=[0, 1])
parser.add_argument('--fix_sal_encoder', '-fse', default=1.0, type=float, dest='fse')
parser.add_argument('--fix_sal_decoder', '-fsd', default=1.0, type=float, dest='fsd')
...
parser.add_argument('--loss', type=str, default='saloss', choices=["mse", "saloss"])
parser.add_argument('--cc_w', type=float, default=2)  # 2
parser.add_argument("--sim_w", type=float, default=1)  # 1
parser.add_argument("--kldiv_w", type=float, default=10)  # 10
parser.add_argument("--nss_w", type=float, default=1)  # 1
parser.add_argument("--mse_w", type=float, default=4)
...
parser.add_argument("--fix_rate", type=float, default=0.9)
